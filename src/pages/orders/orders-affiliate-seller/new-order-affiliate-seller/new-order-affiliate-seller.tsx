...
import { setOrderAffiliateSeller } from "state/api-calls/order-affiliate-calls";
import GeneralInformation from "./sections/general-infos";

const NewOrderAffiliateSeller = () => {
  const {
    register: register,
  ...
  //handle submit form
  const {cart, setCart, handleSubmitOrder, disableSubmitButton } = useOrderSubmission(
    setOrderAffiliateSeller,
    reset,
  );
...
export default NewOrderAffiliateSeller;
