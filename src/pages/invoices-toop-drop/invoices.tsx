...
import { getInvoice } from "state/api-calls/invoice-toop-drop-calls";
...
const ListInvoiceToopDrop = () => {
  const [_, setSearchParams] = useSearchParams();

  const invoices = useSelector((state: any) => state.invoiceToopDrop.invoices);
...
export default ListInvoiceToopDrop;
