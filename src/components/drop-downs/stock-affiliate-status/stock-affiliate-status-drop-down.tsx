...
import { updateAffiliateStockStatus } from "state/api-calls/stock-calls";
import "./stock-affiliate-status-drop-down.scss";

const DropdownStockAffiliateStatus = ({
  choosenSubProduct,
  initStatus,
  stockId,
  setStocks,
  ...
  const handleConfirm = async () => {
    ...
    try {
      await updateAffiliateStockStatus(
        stockId,
        {
      ...
      if (!error) {
        ...
        const fetchData = async () => {
          const res = await baseRequest.get(
            `/stock-affiliate/pagination?productId=${choosenSubProduct._id}`,
          );
...
export default DropdownStockAffiliateStatus;
